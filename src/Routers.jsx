...
import MusicPlayer from "./views/details/MusicPlayer";
import AlbumDetail from "./views/details/AlbumDetail";
import Chart from "./views/details/Chart";
import Layout from "./components/layout/Layout";
import Around from "./views/around/Around";
    ...
    <BrowserRouter basename={process.env.PUBLIC_URL}>
      <Routes>
        <Route element={<Layout />}>
          ...
          <Route
            path="/album/:index"
            element={<AlbumDetail slides={detail} />}
          />
        </Route>
      </Routes>
    </BrowserRouter>
